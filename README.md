...
- **Three wheel layers** — modifier+click opens Layer 1; press 1/2/3 before or during a gesture to switch layers (up to 12 actions). The wheel updates live and shows layer indicator dots.
...
4. Press 1, 2, or 3 with the modifier held — before clicking or while the wheel is open — to switch layers.
